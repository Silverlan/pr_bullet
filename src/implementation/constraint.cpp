...
pragma::physics::BtConstraint::BtConstraint(pragma::physics::IEnvironment &env, std::unique_ptr<btTypedConstraint> c) : IConstraint {env}, m_constraint {std::move(c)} {}
...
pragma::physics::BtFixedConstraint::BtFixedConstraint(IEnvironment &env, std::unique_ptr<btFixedConstraint> constraint) : IFixedConstraint {env}, BtConstraint {env, std::move(constraint)}, IConstraint {env}
{
...
pragma::physics::BtBallSocketConstraint::BtBallSocketConstraint(IEnvironment &env, std::unique_ptr<btPoint2PointConstraint> constraint) : IBallSocketConstraint {env}, BtConstraint {env, std::move(constraint)}, IConstraint {env} {}
...
pragma::physics::BtHingeConstraint::BtHingeConstraint(IEnvironment &env, std::unique_ptr<btHingeConstraint> constraint) : IHingeConstraint {env}, BtConstraint {env, std::move(constraint)}, IConstraint {env} {}
...
void pragma::physics::BtHingeConstraint::SetLimit(float low, float high, float softness, float biasFactor, float relaxationFactor) { GetInternalObject().setLimit(low, high, softness, biasFactor, relaxationFactor); }

////////////////////////////

pragma::physics::BtSliderConstraint::BtSliderConstraint(IEnvironment &env, std::unique_ptr<btSliderConstraint> constraint) : ISliderConstraint {env}, BtConstraint {env, std::move(constraint)}, IConstraint {env} {}
...
pragma::physics::BtConeTwistConstraint::BtConeTwistConstraint(IEnvironment &env, std::unique_ptr<btConeTwistConstraint> constraint) : IConeTwistConstraint {env}, BtConstraint {env, std::move(constraint)}, IConstraint {env}
{
	auto &c = GetInternalObject();
...
{
	GetInternalObject().setLimit(swingSpan1, swingSpan2, twistSpan
...
pragma::physics::BtDoFConstraint::BtDoFConstraint(IEnvironment &env, std::unique_ptr<btGeneric6DofConstraint> constraint) : IDoFConstraint {env}, BtConstraint {env, std::move(constraint)}, IConstraint {env} {}
...
void pragma::physics::BtDoFConstraint::SetLinearLowerLimit(const Vector3 &lim) { GetInternalObject().setLinearLowerLimit(uvec::create_bt(lim) * BtEnvironment::WORLD_SCALE); }
void pragma::physics::BtDoFConstraint::SetLinearUpperLimit(const Vector3 &lim) { GetInternalObject().setLinearUpperLimit(uvec::create_bt(lim) * BtEnvironment::WORLD_SCALE); }
...
pragma::physics::BtDoFSpringConstraint::BtDoFSpringConstraint(IEnvironment &env, std::unique_ptr<btGeneric6DofSpring2Constraint> constraint) : IDoFSpringConstraint {env}, BtConstraint {env, std::move(constraint)}, IConstraint {env}
{
	auto &c = GetInternalObject();
	m_srcTransform = GetBtEnv().CreateTransform(c.getFrameOffsetA());
	m_tgtTransform = GetBtEnv().CreateTransform(c.getFrameOffsetB());
...
void pragma::physics::BtDoFSpringConstraint::SetLinearUpperLimit(const Vector3 &linearUpper) { GetInternalObject().setLinearUpperLimit(uvec::create_bt(linearUpper) * BtEnvironment::WORLD_SCALE); }
...
void pragma::physics::BtDoFSpringConstraint::SetAngularLowerLimit(const Vector3 &angularLower) { GetInternalObject().setAngularLowerLimit(uvec::create_bt(angularLower)); }
void pragma::physics::BtDoFSpringConstraint::SetAngularLowerLimitReversed(const Vector3 &angularLower) { GetInternalObject().setAngularLowerLimitReversed(uvec::create_bt(angularLower)); }
...
void pragma::physics::BtDoFSpringConstraint::SetAngularUpperLimit(const Vector3 &angularUpper) { GetInternalObject().setAngularUpperLimit(uvec::create_bt(angularUpper)); }
void pragma::physics::BtDoFSpringConstraint::SetAngularUpperLimitReversed(const Vector3 &angularUpper) { GetInternalObject().setAngularUpperLimitReversed(uvec::create_bt(angularUpper)); }
...
bool pragma::physics::BtDoFSpringConstraint::IsLimited(AxisType type, pragma::Axis axis) const { return GetInternalObject().isLimited(get_axis_index(type, axis)); }
void pragma::physics::BtDoFSpringConstraint::SetRotationOrder(pragma::RotationOrder order) { GetInternalObject().setRotationOrder(get_spring_rotation_order(order)); }
pragma::RotationOrder pragma::physics::BtDoFSpringConstraint::GetRotationOrder() const { return get_rotation_order(GetInternalObject().getRotationOrder()); }
void pragma::physics::BtDoFSpringConstraint::SetAxis(const Vector3 &axis1, const Vector3 &axis2) { GetInternalObject().setAxis(uvec::create_bt(axis1), uvec::create_bt(axis2)); }
void pragma::physics::BtDoFSpringConstraint::SetBounce(AxisType type, pragma::Axis axis, double bounce) { GetInternalObject().setBounce(get_axis_index(type, axis), bounce); }
void pragma::physics::BtDoFSpringConstraint::EnableMotor(AxisType type, pragma::Axis axis, bool onOff) { GetInternalObject().enableMotor(get_axis_index(type, axis), onOff); }
void pragma::physics::BtDoFSpringConstraint::SetServo(AxisType type, pragma::Axis axis, bool onOff) { GetInternalObject().setServo(get_axis_index(type, axis), onOff); }
void pragma::physics::BtDoFSpringConstraint::SetTargetVelocity(AxisType type, pragma::Axis axis, double velocity) { GetInternalObject().setTargetVelocity(get_axis_index(type, axis), velocity); }
void pragma::physics::BtDoFSpringConstraint::SetServoTarget(AxisType type, pragma::Axis axis, double target) { GetInternalObject().setServoTarget(get_axis_index(type, axis), target); }
void pragma::physics::BtDoFSpringConstraint::SetMaxMotorForce(AxisType type, pragma::Axis axis, double force) { GetInternalObject().setMaxMotorForce(get_axis_index(type, axis), force); }
void pragma::physics::BtDoFSpringConstraint::EnableSpring(AxisType type, pragma::Axis axis, bool onOff) { GetInternalObject().enableSpring(get_axis_index(type, axis), onOff); }
void pragma::physics::BtDoFSpringConstraint::SetStiffness(AxisType type, pragma::Axis axis, double stiffness, bool limitIfNeeded) { GetInternalObject().setStiffness(get_axis_index(type, axis), stiffness, limitIfNeeded); }
void pragma::physics::BtDoFSpringConstraint::SetDamping(AxisType type, pragma::Axis axis, double damping, bool limitIfNeeded) { GetInternalObject().setDamping(get_axis_index(type, axis), damping, limitIfNeeded); }
void pragma::physics::BtDoFSpringConstraint::SetEquilibriumPoint() { GetInternalObject().setEquilibriumPoint(); }
void pragma::physics::BtDoFSpringConstraint::SetEquilibriumPoint(AxisType type, pragma::Axis axis) { GetInternalObject().setEquilibriumPoint(get_axis_index(type, axis)); }
void pragma::physics::BtDoFSpringConstraint::SetEquilibriumPoint(AxisType type, pragma::Axis axis, double val) { GetInternalObject().setEquilibriumPoint(get_axis_index(type, axis), val); }
void pragma::physics::BtDoFSpringConstraint::SetERP(AxisType type, pragma::Axis axis, double value) { GetInternalObject().setParam(BT_CONSTRAINT_ERP, value, get_axis_index(type, axis)); }
double pragma::physics::BtDoFSpringConstraint::GetERP(AxisType type, pragma::Axis axis) const { return GetInternalObject().getParam(BT_CONSTRAINT_ERP, get_axis_index(type, axis)); }
void pragma::physics::BtDoFSpringConstraint::SetStopERP(AxisType type, pragma::Axis axis, double value) { GetInternalObject().setParam(BT_CONSTRAINT_STOP_ERP, value, get_axis_index(type, axis)); }
double pragma::physics::BtDoFSpringConstraint::GetStopERP(AxisType type, pragma::Axis axis) const { return GetInternalObject().getParam(BT_CONSTRAINT_STOP_ERP, get_axis_index(type, axis)); }
void pragma::physics::BtDoFSpringConstraint::SetCFM(AxisType type, pragma::Axis axis, double value) { GetInternalObject().setParam(BT_CONSTRAINT_CFM, value, get_axis_index(type, axis)); }
double pragma::physics::BtDoFSpringConstraint::GetCFM(AxisType type, pragma::Axis axis) const { return GetInternalObject().getParam(BT_CONSTRAINT_CFM, get_axis_index(type, axis)); }
void pragma::physics::BtDoFSpringConstraint::SetStopCFM(AxisType type, pragma::Axis axis, double value) { GetInternalObject().setParam(BT_CONSTRAINT_STOP_CFM, value, get_axis_index(type, axis)); }
double pragma::physics::BtDoFSpringConstraint::GetStopCFM(AxisType type, pragma::Axis axis) const { return GetInternalObject().getParam(BT_CONSTRAINT_STOP_CFM, get_axis_index(type, axis)); }
bool pragma::physics::BtDoFSpringConstraint::MatrixToEulerXYZ(const btMatrix3x3 &mat, btVector3 &xyz) const { return GetInternalObject().matrixToEulerXYZ(mat, xyz); }
bool pragma::physics::BtDoFSpringConstraint::MatrixToEulerXZY(const btMatrix3x3 &mat, btVector3 &xyz) const { return GetInternalObject().matrixToEulerXZY(mat, xyz); }
bool pragma::physics::BtDoFSpringConstraint::MatrixToEulerYXZ(const btMatrix3x3 &mat, btVector3 &xyz) const { return GetInternalObject().matrixToEulerYXZ(mat, xyz); }
bool pragma::physics::BtDoFSpringConstraint::MatrixToEulerYZX(const btMatrix3x3 &mat, btVector3 &xyz) const { return GetInternalObject().matrixToEulerYZX(mat, xyz); }
bool pragma::physics::BtDoFSpringConstraint::MatrixToEulerZXY(const btMatrix3x3 &mat, btVector3 &xyz) const { return GetInternalObject().matrixToEulerZXY(mat, xyz); }
bool pragma::physics::BtDoFSpringConstraint::MatrixToEulerZYX(const btMatrix3x3 &mat, btVector3 &xyz) const { return GetInternalObject().matrixToEulerZYX(mat, xyz); }
