 ...
 */
btVector3 PhysKinematicCharacterController::computeReflectionDirection (const btVector3& direction, const btVector3& normal)
{
 ...
 */
btVector3 PhysKinematicCharacterController::perpindicularComponent (const btVector3& direction, const btVector3& normal)
{
...
btPairCachingGhostObject* PhysKinematicCharacterController::getGhostObject()
{
...
void PhysKinematicCharacterController::setWalkDirection
(
...
void PhysKinematicCharacterController::setVelocityForTimeInterval
(
...
void PhysKinematicCharacterController::setAngularVelocity(const btVector3& velocity)
{
	m_AngVel = velocity;
}

const btVector3& PhysKinematicCharacterController::getAngularVelocity() const
{
	return m_AngVel;
}
...
btVector3 PhysKinematicCharacterController::getLinearVelocity() const
{
...
void PhysKinematicCharacterController::setFallSpeed (btScalar fallSpeed)
{
...
void PhysKinematicCharacterController::setMaxJumpHeight (btScalar maxJumpHeight)
{
	m_maxJumpHeight = maxJumpHeight;
}

bool PhysKinematicCharacterController::canJump () const
{
	return onGround();
}
...
btVector3 PhysKinematicCharacterController::getGravity() const
{
...
btScalar PhysKinematicCharacterController::getMaxSlope() const
{
	return m_maxSlopeRadians;
}

void PhysKinematicCharacterController::setMaxPenetrationDepth(btScalar d)
{
	m_maxPenetrationDepth = d;
}

btScalar PhysKinematicCharacterController::getMaxPenetrationDepth() const
{
	return m_maxPenetrationDepth;
}

bool PhysKinematicCharacterController::onGround () const
{
	return (fabs(m_verticalVelocity) < SIMD_EPSILON) && (fabs(m_verticalOffset) < SIMD_EPSILON);
}

void PhysKinematicCharacterController::setStepHeight(btScalar h) 
{
	m_stepHeight = h;
}
...
void PhysKinematicCharacterController::setUpInterpolate(bool value)
{
